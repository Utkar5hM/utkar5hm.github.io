...
Since I don't have a viable endpoint where we can possibly find the above files, looks like we need to enumerate subdomains. (I've added the ip with domain siteisup.htb to hosts)
