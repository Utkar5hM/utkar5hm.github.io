---
title: ProxyChains and FoxyProxy - Notes
date: 2022-07-01 00:00:00 +530
categories: [ Cyber Security Notes, Pivoting]
tags: [Notes, Pentesting, Pivoting, Proxy, Red Team]     # TAG names should always be lowercase
---
...
Speaking of the `proxychains.conf` file, there is only one section of particular use to us at this moment of time: right at the bottom of the file are the servers used by the proxy. You can set more than one server here to chain proxies together

![screenshot](/assets/img/notes/pivoting/img3.png)
...
- It will be _extremely_ slow. Try to only use Nmap through a proxy when using the NSE 
...
Easy GUI tool - figure out on ur own.
