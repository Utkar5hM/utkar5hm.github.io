...
date: 2022-07-12 00:00:02 +530
categories: [Write Up, TryHackMe]
tags: [write up, tryhackme, ctf, hard, red team] # TAG names should always be lowercase
image: 
   path: /assets/img/thm/yotd/head.png
---
...
SI kinda suck at sqli, I found this resource that I am following rn: [LINK](https://null-byte.wonderhowto.com/how-to/use-sql-injection-run-os-commands-get-shell-0191405/)
...
while adding the header to all fkin requests, successfully permanently disabled 2fa :p.
