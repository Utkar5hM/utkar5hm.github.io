...
date: 2024-11-22 00:00:00 +530
categories: [Benchmark]
tags: [linux, c, ebpf, mariadb, mysql, grafana, performance_schema, query, golang, go] # TAG names should always be lowercase
---
...
Once my summer internship wrapped up and I had some breathing room, I decided to channel that extra time into learning eBPF by building my own monitoring tool. But here’s the plot twist: I finished building it and then... completely dipped. 💀 Didn’t test it, didn’t use it—just straight-up ghosted the whole project for over a year.

![meme](/assets/img/other/ebpf-perf/2024-10-12_23-18.png)
