...
date: 2022-05-02 00:00:00 +530
categories: [ Tutorial, Guide]
tags: [Guide, Linux, Hotspot, MT7921, Drivers]     # TAG names should always be lowercase
---
...
First you need to copy the link for a stock kernel tarball for which you can go to the following link: [kernel.org](kernel.org) (I will be showing off commands with v5.17.9)
